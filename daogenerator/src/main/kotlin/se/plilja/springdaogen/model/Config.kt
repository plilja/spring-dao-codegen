...
data class Config(
        ...
        val queryablePrefix: String = "",
        val queryableSuffix: String = "Queryable",
...
private class ConfigReader(file: File) {
    ...
    fun readConfig(): Config {
        return Config(
                ...
                queryablePrefix = properties.getProperty("queryable.output_prefix", ""),
                queryableSuffix = properties.getProperty("queryable.output_suffix", "Queryable"),
