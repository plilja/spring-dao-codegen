...
public class DataTypesPostgresDao extends Dao<DataTypesPostgresEntity, Long> {
    ...
    public static final Column.LongColumn<DataTypesPostgresEntity> COLUMN_ID = new Column.LongColumn<>("id", "id");

    public static final Column.LongColumn<DataTypesPostgresEntity> COLUMN_BIGINT = new Column.LongColumn<>("bigint", "bigint");

    public static final Column.BooleanColumn<DataTypesPostgresEntity> COLUMN_BOOLEAN_B = new Column.BooleanColumn<>("boolean_b", "booleanB");

    public static final Column<DataTypesPostgresEntity, byte[]> COLUMN_BYTEA = new Column<>("bytea", "bytea", byte[].class);

    public static final Column.StringColumn<DataTypesPostgresEntity> COLUMN_CHAR = new Column.StringColumn<>("char", "chaR");

    public static final Column.StringColumn<DataTypesPostgresEntity> COLUMN_CHAR10 = new Column.StringColumn<>("char10", "char10");

    public static final Column.DateColumn<DataTypesPostgresEntity> COLUMN_DATE = new Column.DateColumn<>("date", "date");

    public static final Column.LongColumn<DataTypesPostgresEntity> COLUMN_DECIMAL_EIGHTEEN_ZERO = new Column.LongColumn<>("decimal_eighteen_zero", "decimalEighteenZero");

    public static final Column.IntColumn<DataTypesPostgresEntity> COLUMN_DECIMAL_NINE_ZERO = new Column.IntColumn<>("decimal_nine_zero", "decimalNineZero");
    ...
    public static final Column.BigDecimalColumn<DataTypesPostgresEntity> COLUMN_DECIMAL_TEN_TWO = new Column.BigDecimalColumn<>("decimal_ten_two", "decimalTenTwo");

    public static final Column.LongColumn<DataTypesPostgresEntity> COLUMN_DECIMAL_TEN_ZERO = new Column.LongColumn<>("decimal_ten_zero", "decimalTenZero");

    public static final Column.DoubleColumn<DataTypesPostgresEntity> COLUMN_DOUBLE = new Column.DoubleColumn<>("double", "doublE");
    ...
    public static final Column.IntColumn<DataTypesPostgresEntity> COLUMN_INTEGER = new Column.IntColumn<>("integer", "integer");

    public static final Column.BigDecimalColumn<DataTypesPostgresEntity> COLUMN_NUMERIC_TEN_TWO = new Column.BigDecimalColumn<>("numeric_ten_two", "numericTenTwo");

    public static final Column.IntColumn<DataTypesPostgresEntity> COLUMN_SMALLINT = new Column.IntColumn<>("smallint", "smallint");

    public static final Column.StringColumn<DataTypesPostgresEntity> COLUMN_TEXT = new Column.StringColumn<>("text", "text");

    public static final Column<DataTypesPostgresEntity, LocalTime> COLUMN_TIME = new Column<>("time", "time", LocalTime.class);

    public static final Column.DateTimeColumn<DataTypesPostgresEntity> COLUMN_TIMESTAMP = new Column.DateTimeColumn<>("timestamp", "timestamp");
    ...
    public static final Column.StringColumn<DataTypesPostgresEntity> COLUMN_VARCHAR10 = new Column.StringColumn<>("varchar10", "varchar10");
