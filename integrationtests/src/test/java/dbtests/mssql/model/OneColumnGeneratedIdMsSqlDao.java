...
public class OneColumnGeneratedIdMsSqlDao extends Dao<OneColumnGeneratedIdMsSqlEntity, Integer> {
    ...
    public static final Column.IntColumn<OneColumnGeneratedIdMsSqlEntity> COLUMN_ID = new Column.IntColumn<>("id", "id");

    private static final List<Column<OneColumnGeneratedIdMsSqlEntity, ?>> ALL_COLUMNS_LIST = Arrays.asList(
            COLUMN_ID);
    ...
    @Override
    protected List<Column<OneColumnGeneratedIdMsSqlEntity, ?>> getColumnsList() {
