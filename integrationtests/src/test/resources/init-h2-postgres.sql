...
MERGE INTO test_schema.color_enum_postgres(id, hex) VALUES('red', '#FF0000');
MERGE INTO test_schema.color_enum_postgres(id, hex) VALUES('green', '#00FF00');
MERGE INTO test_schema.color_enum_postgres(id, hex) VALUES('blue', '#0000FF');
