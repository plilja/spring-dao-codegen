...
rm $(dirname $0)/generated-different-configs/mssql-h2/src/test/java/db/*
rm $(dirname $0)/generated-different-configs/mssql-h2/src/test/resources/*
rm $(dirname $0)/generated-different-configs/oracle-h2/src/test/java/db/*
rm $(dirname $0)/generated-different-configs/oracle-h2/src/test/resources/*
...
java -jar $(dirname $0)/daogenerator/target/daogenerator-0.1-spring-boot.jar generated-different-configs/mssql-h2/mssql-h2.properties
java -jar $(dirname $0)/daogenerator/target/daogenerator-0.1-spring-boot.jar generated-different-configs/oracle-h2/oracle-h2.properties
