...
@Repository
public class DataTypesMsSqlH2Dao extends Dao<DataTypesMsSqlH2, Long> {

    public static final Column<DataTypesMsSqlH2, Long> COLUMN_ID = new Column<>("id");

    public static final Column<DataTypesMsSqlH2, byte[]> COLUMN_BINARY10 = new Column<>("binary10");

    public static final Column<DataTypesMsSqlH2, Boolean> COLUMN_BIT = new Column<>("bit");

    public static final Column<DataTypesMsSqlH2, String> COLUMN_CHAR = new Column<>("char");

    public static final Column<DataTypesMsSqlH2, String> COLUMN_CHAR10 = new Column<>("char10");

    public static final Column<DataTypesMsSqlH2, LocalDate> COLUMN_DATE = new Column<>("date");

    public static final Column<DataTypesMsSqlH2, LocalDateTime> COLUMN_DATETIME = new Column<>("datetime");

    public static final Column<DataTypesMsSqlH2, LocalDateTime> COLUMN_DATETIME2 = new Column<>("datetime2");

    public static final Column<DataTypesMsSqlH2, Long> COLUMN_DECIMAL_EIGHTEEN_ZERO = new Column<>("decimal_eighteen_zero");

    public static final Column<DataTypesMsSqlH2, Integer> COLUMN_DECIMAL_NINE_ZERO = new Column<>("decimal_nine_zero");

    public static final Column<DataTypesMsSqlH2, BigInteger> COLUMN_DECIMAL_NINETEEN_ZERO = new Column<>("decimal_nineteen_zero");

    public static final Column<DataTypesMsSqlH2, BigDecimal> COLUMN_DECIMAL_TEN_TWO = new Column<>("decimal_ten_two");

    public static final Column<DataTypesMsSqlH2, Long> COLUMN_DECIMAL_TEN_ZERO = new Column<>("decimal_ten_zero");

    public static final Column<DataTypesMsSqlH2, Float> COLUMN_FLOAT = new Column<>("float");

    public static final Column<DataTypesMsSqlH2, Integer> COLUMN_INT = new Column<>("int");

    public static final Column<DataTypesMsSqlH2, BigDecimal> COLUMN_MONEY = new Column<>("money");

    public static final Column<DataTypesMsSqlH2, String> COLUMN_NCHAR10 = new Column<>("nchar10");

    public static final Column<DataTypesMsSqlH2, String> COLUMN_NTEXT = new Column<>("ntext");

    public static final Column<DataTypesMsSqlH2, String> COLUMN_NVARCHAR10 = new Column<>("nvarchar10");

    public static final Column<DataTypesMsSqlH2, Float> COLUMN_REAL = new Column<>("real");

    public static final Column<DataTypesMsSqlH2, Integer> COLUMN_SMALLINT = new Column<>("smallint");

    public static final Column<DataTypesMsSqlH2, BigDecimal> COLUMN_SMALLMONEY = new Column<>("smallmoney");

    public static final Column<DataTypesMsSqlH2, String> COLUMN_TEXT = new Column<>("text");

    public static final Column<DataTypesMsSqlH2, LocalTime> COLUMN_TIME = new Column<>("time");

    public static final Column<DataTypesMsSqlH2, Integer> COLUMN_TINYINT = new Column<>("tinyint");

    public static final Column<DataTypesMsSqlH2, byte[]> COLUMN_VARBINARY10 = new Column<>("varbinary10");

    public static final Column<DataTypesMsSqlH2, String> COLUMN_VARCHAR10 = new Column<>("varchar10");

    public static final Column<DataTypesMsSqlH2, String> COLUMN_XML = new Column<>("xml");

    public static final List<Column<DataTypesMsSqlH2, ?>> ALL_COLUMNS_LIST = Arrays.asList(
            COLUMN_ID,
            COLUMN_BINARY10,
            COLUMN_BIT,
            COLUMN_CHAR,
    ...
    private static final RowMapper<DataTypesMsSqlH2> ROW_MAPPER = (rs, i) -> {
        DataTypesMsSqlH2 r = new DataTypesMsSqlH2();
    ...
    @Autowired
    public DataTypesMsSqlH2Dao(NamedParameterJdbcTemplate jdbcTemplate, CurrentUserProvider currentUserProvider) {
        super(Long.class, true, jdbcTemplate, currentUserProvider);
    }

    @Override
    protected SqlParameterSource getParams(DataTypesMsSqlH2 o) {
    ...
    @Override
    protected RowMapper<DataTypesMsSqlH2> getRowMapper() {
        return ROW_MAPPER;
    }
    ...
    @Override
    public Column<DataTypesMsSqlH2, ?> getColumnByName(String name) {
        for (Column<DataTypesMsSqlH2, ?> column : ALL_COLUMNS_LIST) {
