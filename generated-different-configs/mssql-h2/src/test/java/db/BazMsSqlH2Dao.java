...
@Repository
public class BazMsSqlH2Dao extends Dao<BazMsSqlH2, Integer> {

    public static final Column<BazMsSqlH2, Integer> COLUMN_ID = new Column<>("id");

    public static final Column<BazMsSqlH2, ColorEnumMsSql> COLUMN_COLOR = new Column<>("color");

    public static final Column<BazMsSqlH2, LocalDateTime> COLUMN_INSERTED_AT = new Column<>("inserted_at");

    public static final Column<BazMsSqlH2, String> COLUMN_INSERTED_BY = new Column<>("inserted_by");

    public static final Column<BazMsSqlH2, LocalDateTime> COLUMN_MODIFIED_AT = new Column<>("modified_at");

    public static final Column<BazMsSqlH2, String> COLUMN_MODIFIED_BY = new Column<>("modified_by");

    public static final Column<BazMsSqlH2, String> COLUMN_NAME = new Column<>("name");

    public static final Column<BazMsSqlH2, Integer> COLUMN_VERSION = new Column<>("version");

    public static final List<Column<BazMsSqlH2, ?>> ALL_COLUMNS_LIST = Arrays.asList(
            COLUMN_ID,
            COLUMN_COLOR,
            COLUMN_INSERTED_AT,
            COLUMN_INSERTED_BY,
    ...
    private static final RowMapper<BazMsSqlH2> ROW_MAPPER = (rs, i) -> {
        BazMsSqlH2 r = new BazMsSqlH2();
    ...
    @Autowired
    public BazMsSqlH2Dao(NamedParameterJdbcTemplate jdbcTemplate, CurrentUserProvider currentUserProvider) {
        super(Integer.class, true, jdbcTemplate, currentUserProvider);
    }

    @Override
    protected SqlParameterSource getParams(BazMsSqlH2 o) {
    ...
    @Override
    protected RowMapper<BazMsSqlH2> getRowMapper() {
        return ROW_MAPPER;
    }
    ...
    @Override
    public Column<BazMsSqlH2, ?> getColumnByName(String name) {
        for (Column<BazMsSqlH2, ?> column : ALL_COLUMNS_LIST) {
