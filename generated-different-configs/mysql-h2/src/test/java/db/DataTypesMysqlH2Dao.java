...
@Repository
public class DataTypesMysqlH2Dao extends Dao<DataTypesMysqlH2, Long> {

    public static final Column<DataTypesMysqlH2, Long> COLUMN_ID = new Column<>("id");

    public static final Column<DataTypesMysqlH2, Long> COLUMN_BIGINT = new Column<>("`bigint`");

    public static final Column<DataTypesMysqlH2, Boolean> COLUMN_BIT = new Column<>("`bit`");

    public static final Column<DataTypesMysqlH2, byte[]> COLUMN_BLOB = new Column<>("`blob`");

    public static final Column<DataTypesMysqlH2, Boolean> COLUMN_BOOL = new Column<>("`bool`");

    public static final Column<DataTypesMysqlH2, LocalDate> COLUMN_DATE = new Column<>("`date`");

    public static final Column<DataTypesMysqlH2, LocalDateTime> COLUMN_DATETIME = new Column<>("`datetime`");

    public static final Column<DataTypesMysqlH2, Long> COLUMN_DECIMAL_EIGHTEEN_ZERO = new Column<>("decimal_eighteen_zero");

    public static final Column<DataTypesMysqlH2, Integer> COLUMN_DECIMAL_NINE_ZERO = new Column<>("decimal_nine_zero");

    public static final Column<DataTypesMysqlH2, BigInteger> COLUMN_DECIMAL_NINETEEN_ZERO = new Column<>("decimal_nineteen_zero");

    public static final Column<DataTypesMysqlH2, BigDecimal> COLUMN_DECIMAL_TEN_TWO = new Column<>("decimal_ten_two");

    public static final Column<DataTypesMysqlH2, Long> COLUMN_DECIMAL_TEN_ZERO = new Column<>("decimal_ten_zero");

    public static final Column<DataTypesMysqlH2, Double> COLUMN_DOUBLE = new Column<>("`double`");

    public static final Column<DataTypesMysqlH2, Float> COLUMN_FLOAT = new Column<>("`float`");

    public static final Column<DataTypesMysqlH2, Integer> COLUMN_INT = new Column<>("`int`");

    public static final Column<DataTypesMysqlH2, Integer> COLUMN_INTEGER = new Column<>("`integer`");

    public static final Column<DataTypesMysqlH2, String> COLUMN_JSON = new Column<>("`json`");

    public static final Column<DataTypesMysqlH2, Integer> COLUMN_MEDIUMINT = new Column<>("`mediumint`");

    public static final Column<DataTypesMysqlH2, Integer> COLUMN_SMALLINT = new Column<>("`smallint`");

    public static final Column<DataTypesMysqlH2, String> COLUMN_TEXT = new Column<>("`text`");

    public static final Column<DataTypesMysqlH2, LocalTime> COLUMN_TIME = new Column<>("`time`");

    public static final Column<DataTypesMysqlH2, LocalDateTime> COLUMN_TIMESTAMP = new Column<>("`timestamp`");

    public static final Column<DataTypesMysqlH2, byte[]> COLUMN_TINYBLOB = new Column<>("`tinyblob`");

    public static final Column<DataTypesMysqlH2, Integer> COLUMN_TINYINT = new Column<>("`tinyint`");

    public static final Column<DataTypesMysqlH2, String> COLUMN_VARCHAR_10 = new Column<>("varchar_10");

    public static final Column<DataTypesMysqlH2, byte[]> COLUMN_VARCHAR_BINARY_10 = new Column<>("varchar_binary_10");

    public static final Column<DataTypesMysqlH2, Integer> COLUMN_YEAR = new Column<>("`year`");

    public static final List<Column<DataTypesMysqlH2, ?>> ALL_COLUMNS_LIST = Arrays.asList(
            COLUMN_ID,
            COLUMN_BIGINT,
            COLUMN_BIT,
            COLUMN_BLOB,
    ...
    private static final RowMapper<DataTypesMysqlH2> ROW_MAPPER = (rs, i) -> {
        try {
            DataTypesMysqlH2 r = new DataTypesMysqlH2();
    ...
    @Autowired
    public DataTypesMysqlH2Dao(NamedParameterJdbcTemplate jdbcTemplate, CurrentUserProvider currentUserProvider) {
        super(Long.class, true, jdbcTemplate, currentUserProvider);
    }

    @Override
    protected SqlParameterSource getParams(DataTypesMysqlH2 o) {
    ...
    @Override
    protected RowMapper<DataTypesMysqlH2> getRowMapper() {
        return ROW_MAPPER;
    }
    ...
    @Override
    public Column<DataTypesMysqlH2, ?> getColumnByName(String name) {
        for (Column<DataTypesMysqlH2, ?> column : ALL_COLUMNS_LIST) {
